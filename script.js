  ...
  function initNav(){
    document.querySelectorAll('.nav-item').forEach(btn => {
      btn.addEventListener('click', () => {
        ...
        const titles = { dashboard:'Painel do dia', lancamento:'Novo lançamento', historico:'Histórico', despesas:'Cadastro de despesas', manutencao:'Manutenção da moto', corridas:'Corridas individuais', comparar:'Comparação personalizada', padroes:'Padrões & Recomendações', relatorios:'Relatórios', config:'Configurações' };
