...
const UI = (() => {
  ...
  function initNav(){
    document.querySelectorAll('.nav-item').forEach(btn => {
      btn.addEventListener('click', () => {
        ...
        const titles = { dashboard:'Painel do dia', lancamento:'Novo lançamento', historico:'Histórico', despesas:'Cadastro de despesas', manutencao:'Manutenção da moto', comparar:'Comparação personalizada', padroes:'Padrões & Recomendações', relatorios:'Relatórios', config:'Configurações' };
  ...
  function renderPadroes(){
    ...
    paragraphs.push(`<div class="pattern-note">Ainda não é possível calcular <strong>melhor horário do dia</strong> nem <strong>melhor região</strong> — isso exige registrar cada corrida individualmente com hora e local, o que o Lançamento diário atual não faz (ele registra o turno inteiro, não corrida por corrida).</div>`);
